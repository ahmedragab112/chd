...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl({required this.profileEntity});
  ...
  @override
  String toString() {
    return 'ProfileState.success(profileEntity: $profileEntity)';
  }
...
abstract class _Success implements ProfileState {
  const factory _Success({required final ProfileEntity profileEntity}) =
      _$SuccessImpl;
