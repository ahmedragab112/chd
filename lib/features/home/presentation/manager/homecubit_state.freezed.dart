...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl({required this.productEntity});
  ...
  @override
  String toString() {
    return 'HomeState.success(productEntity: $productEntity)';
  }
...
abstract class _Success implements HomeState {
  const factory _Success({required final ProductEntity productEntity}) =
      _$SuccessImpl;
